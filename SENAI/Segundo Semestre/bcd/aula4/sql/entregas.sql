...
LOAD DATA INFILE 'D:/logic/SENAI/Segundo Semestre/bcd/aula4/csv/entregas/clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:/logic/SENAI/Segundo Semestre/bcd/aula4/csv/entregas/entregadores.csv'
...
LOAD DATA INFILE 'D:/logic/SENAI/Segundo Semestre/bcd/aula4/csv/entregas/itens.csv'
INTO TABLE itens
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/logic/SENAI/Segundo Semestre/bcd/aula4/csv/entregas/pedidos.csv'
INTO TABLE pedidos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/logic/SENAI/Segundo Semestre/bcd/aula4/csv/entregas/produtos.csv'
INTO TABLE produtos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
