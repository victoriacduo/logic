...
app.post("/produtos", (req, res) => {
    ...
    */
    ...
    let query = `INSERT INTO produtos VALUES (DEFAULT, '${req.body.cod}', '${req.body.nome}', ${req.body.quantidade}, ${req.body.preco})`;
...
app.put("/produto", (req, res) => {
    let query = `UPDATE produtos SET cod = '${req.body.cod}', nome = '${req.body.nome}', quantidade = ${req.body.quantidade}, preco = ${req.body.preco} WHERE cod = '${req.body.cod}'`;
